...
scrape_configs:
  ...
  - job_name: 'api-gateway'
    static_configs:
      - targets: ['api-gateway.services.internal:8080']

  - job_name: 'order-service'
    static_configs:
      - targets: ['order-service.services.internal:8081']

  - job_name: 'payment-service'
    static_configs:
      - targets: ['payment-service.services.internal:8083']

  - job_name: 'inventory-service'
    static_configs:
      - targets: ['inventory-service.services.internal:8082']

  - job_name: 'notification-service'
    static_configs:
      - targets: ['notification-service.services.internal:8084']

  - job_name: 'shipping-service'
    static_configs:
      - targets: ['shipping-service.services.internal:8085']
